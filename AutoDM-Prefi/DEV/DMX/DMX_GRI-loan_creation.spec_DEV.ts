...
const DEFAULT_LOAN_APPLICATION_URL = 'https://apply-gri.dev.saas.rate.com/apply/loan-purpose?emp-id=12657';
...
test('test', async ({ page }) => {
  ...
  if (!fullBannerText && /(my\.gr-dev\.com|my\.dev\.originpoint\.com)\/loan\/[^/?#]+(\/overview)?$/i.test(page.url())) {
